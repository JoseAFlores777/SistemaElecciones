                        ...
                        <body>
                            <div class="row mb-2 mb-xl-3">
                                <div class="col-auto d-none d-sm-block">
                                    <h3><strong>Elecciones</strong> Partidos Políticos</h3>
                                </div>
...
<li class="breadcrumb-item"><a href="ControladorMenus?accion=Dashboard">Inicio</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Partidos Políticos</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div class="card"  style="padding-top: 20px;">
                                <a href="${pageContext.request.contextPath}/ServletControladorPartidos?accion=Agregar" type="button" class="btn  btn-outline-success" style="margin-left:25%; margin-right: 25%; margin-bottom: 10px;"><i class="fas fa-plus"></i> Agregar</a>

                                <table id="example" class="table display" style="margin-top: 100px;">
                                    <thead>
                                        <tr>
                                            <th style="width:5%;">#</th>
                                            <th style="width:35%;">Nombre del Partido</th>

                                            <th style="width:30%">Bandera</th>
                                        ...
                                        <c:forEach var="partido" items="${partidos}" varStatus="status" >
                                            <tr>
                                                ...
                                                <c:if test="${partido.getEstadoDes()=='Activo'}">
                                                    ...
                                                    <c:if test="${partido.getEstadoDes()=='Inactivo'}">
