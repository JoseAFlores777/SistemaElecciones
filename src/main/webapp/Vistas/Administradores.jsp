                    ...
                    <div class="container-fluid p-0">
                        ...
                        <div class="row mb-2 mb-xl-3">
                            <div class="col-auto d-none d-sm-block">
                                <h3><strong>Usuarios</strong> Administradores</h3>
                            </div>
                        ...
                        <div class="card" style="padding-top: 20px;">
                            ...
                            <table id="example" class="table display" style="margin-top:100%;">
                                <thead>
                                    <tr>
                                        <th style="width:5%;">#</th>
                                        <th style="width:40%;">Nombre del Administrador</th>
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="persona" items="${personas}" varStatus="status" >
                                        <tr>
                                            <td>${status.count}</td>
                                            <td>
                                                <img src="${persona.getFoto()}" width="48" height="48" class="rounded-circle mr-2" alt="Avatar"> ${persona.primer_Nombre} ${persona.segundo_Nombre} ${persona.tercer_Nombre} ${persona.primer_Apellido} ${persona.segundo_Apellido}
                                            </td>
