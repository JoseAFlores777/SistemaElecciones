...
<html lang="es">
    ...
    <head>
        ...
        <title>Candidatos | Alcaldes</title>
    </head>
                        ...
                        <body>
                            <div class="row mb-2 mb-xl-3">
                                <div class="col-auto d-none d-sm-block">
                                    <h3><strong>Candidatos</strong> Alcaldes</h3>
                                </div>
                                ...
                                <div class="col-auto ml-auto text-right mt-n1">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Alcaldes</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div class="card" style="padding-top: 20px;">
                              ...
                              <a  href="${pageContext.request.contextPath}/ServletControlador?accion=BuscarReferencias&user=2" type="button" class="btn  btn-outline-success" style="margin-left:25%; margin-right: 25%; margin-bottom: 10px;"><i class="fas fa-plus"></i> Agregar</a>
                                ...
                                <table id="example" class="table display" style="margin-top:100%;">
                                    <thead>
                                        <tr>
                                            <th style="width:5%;">#</th>
                                            <th style="width:35%;">Nombre del Alcalde</th>
