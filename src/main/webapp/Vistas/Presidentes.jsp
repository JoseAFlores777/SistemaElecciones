...
<html lang="es">
    ...
    <head>
        ...
        <title>Candidatos | Presidentes</title>
    </head>
    ...
    <body>
        <div class="row mb-2 mb-xl-3">
            <div class="col-auto d-none d-sm-block">
                <h3><strong>Candidatos</strong> Presidentes</h3>
            </div>
...
<li class="breadcrumb-item"><a href="ControladorMenus?accion=Dashboard">Inicio</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Presidentes</li>
                    </ol>
                </nav>
            </div>
        </div>
            <%--Fin de Titulo de Página--%>
                        ...
                        <div class="card" style="padding-top: 20px;">
                            ...
                            <a  href="${pageContext.request.contextPath}/ServletControlador?accion=BuscarReferencias&user=1" type="button" class="btn  btn-outline-success" style="margin-left:25%; margin-right: 25%; margin-bottom: 10px;"><i class="fas fa-plus"></i> Agregar</a>
                            ...
                            <table id="example" class="table display" style="margin-top:100%;">
                                <thead>
                                    <tr>
                                        <th style="width:5%;">#</th>
                                        <th style="width:35%;">Nombre del Presidente</th>
