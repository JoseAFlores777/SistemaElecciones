...
<html lang="es">
    ...
    <head>
        ...
        <title>Usuarios | Electores</title>
    </head>
                        ...
                        <body>
                            <div class="row mb-2 mb-xl-3">
                                <div class="col-auto d-none d-sm-block">
                                    <h3><strong>Usuarios</strong> Electores</h3>
                                </div>
...
<li class="breadcrumb-item"><a href="ControladorMenus?accion=Dashboard">Inicio</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Electores</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div class="card" style="padding-top: 20px;">
                                ...
                                <a  href="${pageContext.request.contextPath}/ServletControlador?accion=BuscarReferencias&user=7" type="button" class="btn  btn-outline-success" style="margin-left:25%; margin-right: 25%; margin-bottom: 10px;"><i class="fas fa-plus"></i> Agregar</a>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="persona" items="${personas}" varStatus="status" >
                                            <tr>
                                                ...
                                                <c:if test="${persona.getEstadoVoto_Des()=='Habilitado'}">
                                                    <td><span class="badge bg-primary" >${persona.getEstadoVoto_Des()}</span></td>
                                                    </c:if>
                                                <c:if test="${persona.getEstadoVoto_Des()=='Ya Votó'}">
                                                    <td><span class="badge bg-success" >${persona.getEstadoVoto_Des()}</span></td>
                                                    </c:if>
                                                <c:if test="${persona.getEstadoVoto_Des()=='No Votó'}">
                                                    <td><span class="badge bg-danger" >${persona.getEstadoVoto_Des()}</span></td>
                                                    </c:if>
